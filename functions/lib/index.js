...
exports.qpayCallback = exports.qpayCreateInvoice = exports.onSmsIncome = exports.scheduledCleanup = exports.lowStockAlert = exports.sendOrderNotification = exports.onQrLoginUpdate = exports.onOrderCreate = void 0;
...
function httpsRequest(url, method, headers, body) {
    return new Promise((resolve, reject) => {
        ...
        const options = {
            ...
            method,
            headers: Object.assign(Object.assign({}, headers), (body ? { "Content-Length": Buffer.byteLength(body).toString() } : {})),
        };
...
async function getQPayToken() {
    ...
    const resp = await httpsRequest(`${QPAY_CONFIG.baseUrl}/v2/auth/token`, "POST", {
 ...
 */
exports.qpayCreateInvoice = functions.runWith({ invoker: "public" }).https.onCall(async (data) => {
    ...
    try {
        ...
        const resp = await httpsRequest(`${QPAY_CONFIG.baseUrl}/v2/invoice`, "POST", {
 ...
 */
exports.qpayCallback = functions.runWith({ invoker: "public" }).https.onRequest(async (req, res) => {
    var _a, _b;
    ...
    try {
        ...
        const checkResp = await httpsRequest(`${QPAY_CONFIG.baseUrl}/v2/payment/check`, "POST", {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json",
        }, checkBody);
        ...
        const now = admin.firestore.FieldValue.serverTimestamp();
        const totalAmount = ((_a = orderData.financials) === null || _a === void 0 ? void 0 : _a.totalAmount) || 0;
        ...
        await db.collection(`businesses/${bizId}/notifications`).add({
            ...
            type: 'qpay_payment',
            title: notifTitle,
            body: `₮${totalAmount.toLocaleString()} — ${((_b = orderData.customer) === null || _b === void 0 ? void 0 : _b.name) || 'Зочин'}`,
            icon: '✅',
            link: '/app/orders',
            referenceId: orderId,
            readBy: {},

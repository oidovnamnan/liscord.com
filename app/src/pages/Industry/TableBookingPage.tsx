...
import { CalendarDays, Plus, Users, Clock, CheckCircle2, CalendarCheck} from 'lucide-react';
        ...
        <HubLayout hubId="industry-hub"><div className="fds-hero">
                <div className="fds-hero-top">
                    <div className="fds-hero-left">
                        ...
                        <div>
                            <h3 className="fds-hero-title">Ширээ Захиалга</h3>
                            <div className="fds-hero-desc">Ширээний захиалгын удирдлага</div>
                        </div>
                    </div>

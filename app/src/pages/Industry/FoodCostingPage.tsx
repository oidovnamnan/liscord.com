...
import { Calculator, Plus, DollarSign, TrendingUp, Utensils } from 'lucide-react';
...
export function FoodCostingPage() {
    ...
    return (
        <HubLayout hubId="industry-hub"><Header title="Хоолны өртөг / Food Costing" subtitle="Хоолны орц найрлага, өртөг тооцоолол, ашиг тодорхойлох" action={{ label: 'Хоол нэмэх', onClick: () => { setEditingItem(null); setShowModal(true); } }} />

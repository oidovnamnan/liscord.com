...
export function SelfCheckoutPage() {
    ...
    return (
        <HubLayout hubId="industry-hub"><Header title="Self-Checkout" subtitle="Өөрөө төлбөр хийх киоск удирдлага, борлуулалтын мониторинг" action={{ label: 'Киоск нэмэх', onClick: () => { setEditingItem(null); setShowModal(true); } }} />

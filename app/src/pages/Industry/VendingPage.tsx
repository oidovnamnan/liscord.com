...
import { Coffee, Plus, MapPin, AlertTriangle, CheckCircle2, DollarSign, Box} from 'lucide-react';
        ...
        <HubLayout hubId="industry-hub"><div className="fds-hero">
                <div className="fds-hero-top">
                    <div className="fds-hero-left">
                        <div className="fds-hero-icon"><Box size={24} /></div>
                        <div>
                            <h3 className="fds-hero-title">Вендинг</h3>
                            <div className="fds-hero-desc">Вендинг машины удирдлага</div>
                        </div>
                    </div>

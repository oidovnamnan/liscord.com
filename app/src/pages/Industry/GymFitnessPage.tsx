...
export function GymFitnessPage() {
    ...
    return (
        <HubLayout hubId="industry-hub">
            <Header title="Фитнес & Gym" subtitle="Гишүүдийн бүртгэл, эрхийн хугацаа, дасгалжуулагч хуваарилалт" action={{ label: 'Гишүүн нэмэх', onClick: () => { setEditingItem(null); setShowModal(true); } }} />

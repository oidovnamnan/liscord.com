        ...
        <HubLayout hubId="industry-hub"><div className="fds-hero">
                <div className="fds-hero-top">
                    <div className="fds-hero-left">
                        <div className="fds-hero-icon"><Scale size={24} /></div>
                        <div>
                            <h3 className="fds-hero-title">Жингийн Систем</h3>
                            <div className="fds-hero-desc">Жингийн хэмжүүрийн удирдлага</div>
                        </div>
                    </div>

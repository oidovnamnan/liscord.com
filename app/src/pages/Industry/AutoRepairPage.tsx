...
export function AutoRepairPage() {
    ...
    return (
        <HubLayout hubId="industry-hub">
            <Header title="Авто засвар" subtitle="Засварын ажил, тооцоо, сэлбэг захиалгын бүртгэл" action={{ label: 'Засвар бүртгэх', onClick: () => { setEditingItem(null); setShowModal(true); } }} />

    ...
    return (
        <div className="super-admin-page">
            <header className="super-header">
                <div>
                    <h1 className="page-title">👥 Хэрэглэгчийн удирдлага</h1>
                    <p className="text-secondary">Нийт {users.length} хэрэглэгч бүртгэлтэй байна</p>
                </div>
            </header>
                    ...
                    <tbody>
                        {loading ? (
                            ...
                            <tr key={u.id}>
                                ...
                                <td>
                                    <span className="count-badge">{u.businessIds?.length || 0} бизнес</span>
                                </td>
                                <td>
                                    {u.isSuperAdmin ? (
                                ...
                                <td>
                                    <div className="row-actions">
                                        <button className="btn-icon" title="Эрх засах"><Shield size={16} /></button>
                                        <button className="btn-icon text-danger" title="Блок хийх"><Ban size={16} /></button>

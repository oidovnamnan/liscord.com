...
import { Building2, Calendar, CheckSquare, XSquare, Loader2, Sparkles, ClipboardList, RefreshCw } from 'lucide-react';
...
export function SuperAdminRequests() {
    ...
    return (
        <div className="page-container animate-fade-in" style={{ padding: '24px clamp(16px, 3vw, 32px) 32px' }}>
            {/* ── Premium Hero ── */}
            <div className="sa-hero" style={{ background: 'linear-gradient(135deg, #0284c7 0%, #6366f1 50%, #a855f7 100%)', boxShadow: '0 8px 32px rgba(99, 102, 241, 0.25)' }}>
                <div className="sa-hero-top">
                    <div className="sa-hero-left">
                        <div className="sa-hero-icon"><ClipboardList size={24} /></div>
                        <div>
                            <div className="sa-hero-badge"><Sparkles size={10} /> Хүсэлт удирдлага</div>
                            <h1 className="sa-hero-title">Зөвшөөрлийн Хүсэлтүүд</h1>
                            <div className="sa-hero-desc">Бизнесүүдийн дэлгүүрийн нэр болон холбоос өөрчлөх хүсэлтүүдийн хяналт</div>
                        </div>
                    </div>
                    <button
                ...
                <div className="sa-hero-stats" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
                    <div className="sa-hero-stat">
                        <div className="sa-hero-stat-value">{totalRequests}</div>
                        <div className="sa-hero-stat-label">Хүлээгдэж буй</div>
                    </div>
                    <div className="sa-hero-stat">
                        <div className="sa-hero-stat-value" style={{ fontSize: '1rem' }}>{totalRequests > 0 ? '🟡 Хяналт' : '🟢 Хэвийн'}</div>
                        <div className="sa-hero-stat-label">Төлөв</div>
                    </div>
                    <div className="sa-hero-stat">
                        <div className="sa-hero-stat-value" style={{ fontSize: '1rem' }}>📋</div>
                        <div className="sa-hero-stat-label">Нэр / Холбоос</div>
                    </div>
                </div>
            </div>

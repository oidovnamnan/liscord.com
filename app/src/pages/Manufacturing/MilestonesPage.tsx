...
export function MilestonesPage() {
    ...
    return (
        <HubLayout hubId="manufacturing-hub"><div className="page-container animate-fade-in"><Header title="Чухал Үе Шат" action={{ label: '+ Milestone', onClick: () => { setEditingItem(null); setShowModal(true); } }} />

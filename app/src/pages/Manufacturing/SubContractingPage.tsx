...
export function SubContractingPage() {
    ...
    return (
        <HubLayout hubId="manufacturing-hub"><div className="page-container animate-fade-in"><Header title="Туслан Гүйцэтгэлт" action={{ label: '+ Гэрээ', onClick: () => { setEditingItem(null); setShowModal(true); } }} />

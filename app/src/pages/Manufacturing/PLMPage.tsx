...
export function PLMPage() {
    ...
    return (
        <HubLayout hubId="manufacturing-hub"><div className="page-container animate-fade-in"><Header title="Бүтээгдэхүүний Амьдралын Мөчлөг (PLM)" action={{ label: '+ Бүтээгдэхүүн', onClick: () => { setEditingItem(null); setShowModal(true); } }} />

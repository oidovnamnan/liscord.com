...
export function ArchitectureDesignPage() {
    ...
    return (
        <HubLayout hubId="manufacturing-hub"><div className="page-container animate-fade-in"><Header title="Архитектур & Дизайн" action={{ label: '+ Төсөл', onClick: () => { setEditingItem(null); setShowModal(true); } }} />

...
export function GanttChartPage() {
    ...
    return (
        <HubLayout hubId="manufacturing-hub"><div className="page-container animate-fade-in"><Header title="Гант Диаграм" action={{ label: '+ Ажил', onClick: () => { setEditingItem(null); setShowModal(true); } }} />
